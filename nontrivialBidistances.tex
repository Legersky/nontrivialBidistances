...
\section{Nonrigid Laman subgraph}
\begin{thm}
...
\end{align*}
Hence, the dimension of $X_G$ is at least one, i.e., $|X_G|=\infty$. This means that $(\lambda_e)_{e\in E_G}$ is a nonrigid labeling of $G$.
\end{proof}

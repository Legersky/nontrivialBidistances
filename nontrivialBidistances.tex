...
The idea is following: since the graph $G'\subset G$ is disconnected, every cycle in $G$ which is does not stay in a connected component of $G'$ must go through the given  connecting edges at least twice.

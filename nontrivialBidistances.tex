...
\begin{lem}
Let $T=(V_T,E_T)$ be a \trcomp{} of a Laman graph $G=(V,E)$ with only two connecting vertices $u,v$, If $uv\in E$, then $G$ has a nontrivial bidistance iff $G_{T\rightarrow uv}$ has a nontrivial bidistance.
\end{lem}

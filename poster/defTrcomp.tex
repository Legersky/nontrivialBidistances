...
\SetVertexLabelOut
   ...
   \tikzset{EdgeStyle/.append style = {color=green}}
	...
	\Edge(c)(v)
	\Edge(d)(v)
\end{tikzpicture}\hspace{2cm}\parbox[b]{15cm}{\small
   A graph with two \trcomps{} ({\color{red} red}, {\color{green} green}) and one connecting edge (black). The {\color{blue} blue} vertices are so called \emph{connecting vertices}.
}
\end{tikzfigure}
...
\begin{itemize}
	...
	\item Let $|V_T|\geq 3$. The graph $T$ is a Laman \trcomp{} iff it is a 2-tree.
\end{itemize}
\end{thm}
\begin{thm}
Let $T_1,\dots, T_n$ be a \trcomp{} of a Laman graph $G$.  The following statements hold:
\begin{itemize}
	\item Every \trcomp{} $T_i$ is a Laman graph and 2-tree.

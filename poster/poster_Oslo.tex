...
\definecolor{niceGreen}{HTML}{006400} 
%\definecolor{colorOne}{HTML}{34888C}%116699
...
\begin{minipage}[t]{0.333\linewidth}
	\begin{center}
	\raisebox{-0.5\height}{\includegraphics[scale=0.75]{logos/EU.jpg}\hspace{25mm} }
	\raisebox{-0.5\height}{\includegraphics[scale=0.12]{logos/ARCADES.png} }
	\end{center}
\end{minipage}
\begin{minipage}[t]{0.333\linewidth}\vspace{-10mm}
...
\begin{minipage}[t]{0.333\linewidth}
\begin{center}
	\raisebox{-0.5\height}{\includegraphics[scale=0.8]{logos/RISC.png}\hspace{20mm}}
\raisebox{-0.5\height}{	\includegraphics[scale=0.2]{logos/JKU.png}}
	\end{center}
\end{minipage}
}
\end{columns}

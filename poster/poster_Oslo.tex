...
\useblockstyle[bodyoffsety=15mm]{Slide}
...
%	\begin{center}
%	\includegraphics{logos/RISC.png}\hspace{20mm}
...
%	\end{minipage}
%	\begin{minipage}{0.5\textwidth}
%	\includegraphics[scale=2.5]{logos/ARCADES.png} \hspace{20mm}
%	\includegraphics[scale=1]{logos/EU.png}
%	\end{minipage}
%\end{minipage}
\begin{minipage}[t]{0.33\colwidth}
	\begin{center}
	\includegraphics[scale=0.8]{logos/EU.png}\hspace{20mm}
	\includegraphics[scale=2.5]{logos/ARCADES.png} 
	\end{center}
\end{minipage}
\begin{minipage}[t]{0.33\colwidth}\vspace{-30mm}
	\small \center 	This project has received funding from the European Union's Horizon 2020 research and innovation
	programme under the Marie Sk\l{}odowska-Curie grant agreement No 675789.
\end{minipage}
\begin{minipage}[t]{0.33\colwidth}
\begin{center}
	\vspace{-40mm}\includegraphics[scale=0.9]{logos/RISC.png}\hspace{20mm}
	\includegraphics[scale=0.2]{logos/JKU.png}
	\end{center}
\end{minipage}
}

...
\begin{itemize}
	...
	\item There is a set  $V_{c}=\{v_1, \dots v_r\}$ of pairwise non-adjacent connecting vertices of $G$ such that $G\setminus V_c$ is disconnected.
	\item  There is a set  $E_{c}=\{e_1, \dots e_r\}$ of connecting edges of $G$ such that $G\setminus E_c$ is disconnected.
